...
def export_as_pdf():
    """Export the table generated on the website as a PDF file"""
    page = browser.page()

    sales_results_html = page.locator("#sales-results").inner_html()
    pdf = PDF()
    pdf = pdf.html_to_pdf(sales_results_html, "output/sales_results.pdf", margin=10)

def log_out():
    """Log when automation is done"""
    page = browser.page()
